...
class Ui_AssignLevelsToBuildings_window(object):
    def setupUi(self, AssignLevelsToBuildings_window):
        ...
        AssignLevelsToBuildings_window.resize(713, 350)
        ...
        AssignLevelsToBuildings_window.setMinimumSize(QtCore.QSize(713, 350))
        AssignLevelsToBuildings_window.setMaximumSize(QtCore.QSize(713, 350))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 220, 691, 61))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(10, 290, 691, 41))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 70, 691, 61))
        ...
        self.line.setGeometry(QtCore.QRect(10, 200, 681, 20))
        self.line.setFrameShape(QtGui.QFrame.HLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName(_fromUtf8("line"))
        self.verticalLayoutWidget_3 = QtGui.QWidget(AssignLevelsToBuildings_window)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(10, 140, 691, 54))
        ...
        self.note_label = QtGui.QLabel(AssignLevelsToBuildings_window)
        self.note_label.setGeometry(QtCore.QRect(30, 10, 651, 41))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
